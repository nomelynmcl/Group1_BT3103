    ...
    public partial class RegistrarViewAssessment : Form
    {
        ...
        private void LoadFeeBreakdown(string modeOfPayment)
        {
            ...
            else if (modeOfPayment == "Low Quarterly Payment")
            {
                ...
                dtgBreak.Rows.Add("");
                dtgBreak.Rows.Add("Quarterly Payment (4x)", "₱1,500");
            }
        ...
        private void PrintDoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            // Basic student info
            DrawField("Student ID:", STU_ID_LBL_RGTR.Text);
            DrawField("Full Name:", STU_NAME_LBL_RGTR.Text);
            DrawField("Grade / Section:", SECT_TION_LBL.Text);
            DrawField("Classification:", TYPE_LBL_RGTR.Text);
        ...
        private void RegistrarViewAssessment_Load(object sender, EventArgs e)
        {
        ...
        private void ckPart_CheckedChanged(object sender, EventArgs e)
        {
            if (ckPart.Checked)
            {
