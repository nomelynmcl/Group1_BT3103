namespace EventDriven.Project.UI
{
    partial class AdminReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            AR_NOE = new Label();
            AR_NOES = new Label();
            AR_LOE_GRID = new DataGridView();
            AR_LOE_TXTBOX = new TextBox();
            AR_LOE_BTN = new Button();
            AR_NOTD = new Label();
            label4 = new Label();
            ...
            ((System.ComponentModel.ISupportInitialize)AR_LOE_GRID).BeginInit();
            ((System.ComponentModel.ISupportInitialize)AR_SOA_GRID).BeginInit();
            SuspendLayout();
            // 
            // flowLayoutPanel1
            // 
            ...
            label1.Location = new Point(273, 167);
            label1.Name = "label1";
            ...
            label2.Location = new Point(560, 17);
            label2.Name = "label2";
            ...
            label3.Location = new Point(267, 17);
            label3.Name = "label3";
            ...
            // AR_NOE
            // 
            AR_NOE.AutoSize = true;
            AR_NOE.Font = new Font("Segoe UI", 36F, FontStyle.Bold, GraphicsUnit.Point, 0);
            AR_NOE.Location = new Point(613, 55);
            AR_NOE.Name = "AR_NOE";
            AR_NOE.Size = new Size(56, 65);
            AR_NOE.TabIndex = 84;
            AR_NOE.Text = "0";
            // 
            // AR_NOES
            // 
            AR_NOES.AutoSize = true;
            AR_NOES.Font = new Font("Segoe UI", 36F, FontStyle.Bold, GraphicsUnit.Point, 0);
            AR_NOES.Location = new Point(383, 55);
            AR_NOES.Name = "AR_NOES";
            AR_NOES.Size = new Size(56, 65);
            AR_NOES.TabIndex = 85;
            AR_NOES.Text = "0";
            // 
            // AR_LOE_GRID
            ...
            AR_LOE_GRID.Location = new Point(273, 204);
            ...
            // AR_LOE_TXTBOX
            // 
            AR_LOE_TXTBOX.Location = new Point(501, 168);
            AR_LOE_TXTBOX.Name = "AR_LOE_TXTBOX";
            AR_LOE_TXTBOX.Size = new Size(198, 23);
            AR_LOE_TXTBOX.TabIndex = 87;
            // 
            // AR_LOE_BTN
            // 
            AR_LOE_BTN.Location = new Point(705, 168);
            AR_LOE_BTN.Name = "AR_LOE_BTN";
            AR_LOE_BTN.Size = new Size(75, 23);
            ...
            label5.Location = new Point(819, 168);
            label5.Name = "label5";
            label5.Size = new Size(194, 20);
            label5.TabIndex = 106;
            label5.Text = "STATEMENT OF ACCOUNT";
            // 
            // AR_PRINT_BTN
            // 
            ...
            Controls.Add(label5);
            Controls.Add(AR_NOTD);
            Controls.Add(label4);
            Controls.Add(AR_LOE_BTN);
            Controls.Add(AR_LOE_TXTBOX);
            Controls.Add(AR_LOE_GRID);
            Controls.Add(AR_NOES);
            Controls.Add(AR_NOE);
            Controls.Add(label3);
            Controls.Add(label2);
            Controls.Add(label1);
            ...
            ((System.ComponentModel.ISupportInitialize)AR_LOE_GRID).EndInit();
            ((System.ComponentModel.ISupportInitialize)AR_SOA_GRID).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private Label AR_NOE;
        private Label AR_NOES;
        private DataGridView AR_LOE_GRID;
        private TextBox AR_LOE_TXTBOX;
        private Button AR_LOE_BTN;
        private Label AR_NOTD;
